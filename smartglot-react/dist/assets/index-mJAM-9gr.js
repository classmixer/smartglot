 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var kg;function w0(){if(kg)return re;kg=1;var i=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),r=Symbol.for("react.fragment"),l=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),f=Symbol.for("react.consumer"),d=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),h=Symbol.for("react.suspense"),g=Symbol.for("react.memo"),y=Symbol.for("react.lazy"),b=Symbol.iterator;function S(E){return E===null||typeof E!="object"?null:(E=b&&E[b]||E["@@iterator"],typeof E=="function"?E:null)}var D={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},C=Object.assign,q={};function M(E,B,$){this.props=E,this.context=B,this.refs=q,this.updater=$||D}M.prototype.isReactComponent={},M.prototype.setState=function(E,B){if(typeof E!="object"&&typeof E!="function"&&E!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,E,B,"setState")},M.prototype.forceUpdate=function(E){this.updater.enqueueForceUpdate(this,E,"forceUpdate")};function H(){}H.prototype=M.prototype;function X(E,B,$){this.props=E,this.context=B,this.refs=q,this.updater=$||D}var L=X.prototype=new H;L.constructor=X,C(L,M.prototype),L.isPureReactComponent=!0;var G=Array.isArray,j={H:null,A:null,T:null,S:null,V:null},ae=Object.prototype.hasOwnProperty;function pe(E,B,$,Y,W,de){return $=de.ref,{$$typeof:i,type:E,key:B,ref:$!==void 0?$:null,props:de}}function me(E,B){return pe(E.type,B,void 0,void 0,void 0,E.props)}function ce(E){return typeof E=="object"&&E!==null&&E.$$typeof===i}function Ye(E){var B={"=":"=0",":":"=2"};return"$"+E.replace(/[=:]/g,function($){return B[$]})}var Se=/\/+/g;function Ie(E,B){return typeof E=="object"&&E!==null&&E.key!=null?Ye(""+E.key):B.toString(36)}function mt(){}function Oi(E){switch(E.status){case"fulfilled":return E.value;case"rejected":throw E.reason;default:switch(typeof E.status=="string"?E.then(mt,mt):(E.status="pending",E.then(function(B){E.status==="pending"&&(E.status="fulfilled",E.value=B)},function(B){E.status==="pending"&&(E.status="rejected",E.reason=B)})),E.status){case"fulfilled":return E.value;case"rejected":throw E.reason}}throw E}function st(E,B,$,Y,W){var de=typeof E;(de==="undefined"||de==="boolean")&&(E=null);var ne=!1;if(E===null)ne=!0;else switch(de){case"bigint":case"string":case"number":ne=!0;break;case"object":switch(E.$$typeof){case i:case t:ne=!0;break;case y:return ne=E._init,st(ne(E._payload),B,$,Y,W)}}if(ne)return W=W(E),ne=Y===""?"."+Ie(E,0):Y,G(W)?($="",ne!=null&&($=ne.replace(Se,"$&/")+"/"),st(W,B,$,"",function($n){return $n})):W!=null&&(ce(W)&&(W=me(W,$+(W.key==null||E&&E.key===W.key?"":(""+W.key).replace(Se,"$&/")+"/")+ne)),B.push(W)),1;ne=0;var St=Y===""?".":Y+":";if(G(E))for(var Ne=0;Ne<E.length;Ne++)Y=E[Ne],de=St+Ie(Y,Ne),ne+=st(Y,B,$,de,W);else if(Ne=S(E),typeof Ne=="function")for(E=Ne.call(E),Ne=0;!(Y=E.next()).done;)Y=Y.value,de=St+Ie(Y,Ne++),ne+=st(Y,B,$,de,W);else if(de==="object"){if(typeof E.then=="function")return st(Oi(E),B,$,Y,W);throw B=String(E),Error("Objects are not valid as a React child (found: "+(B==="[object Object]"?"object with keys {"+Object.keys(E).join(", ")+"}":B)+"). If you meant to render a collection of children, use an array instead.")}return ne}function x(E,B,$){if(E==null)return E;var Y=[],W=0;return st(E,Y,"","",function(de){return B.call($,de,W++)}),Y}function F(E){if(E._status===-1){var B=E._result;B=B(),B.then(function($){(E._status===0||E._status===-1)&&(E._status=1,E._result=$)},function($){(E._status===0||E._status===-1)&&(E._status=2,E._result=$)}),E._status===-1&&(E._status=0,E._result=B)}if(E._status===1)return E._result.default;throw E._result}var ee=typeof reportError=="function"?reportError:function(E){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var B=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof E=="object"&&E!==null&&typeof E.message=="string"?String(E.message):String(E),error:E});if(!window.dispatchEvent(B))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",E);return}console.error(E)};function we(){}return re.Children={map:x,forEach:function(E,B,$){x(E,function(){B.apply(this,arguments)},$)},count:function(E){var B=0;return x(E,function(){B++}),B},toArray:function(E){return x(E,function(B){return B})||[]},only:function(E){if(!ce(E))throw Error("React.Children.only expected to receive a single React element child.");return E}},re.Component=M,re.Fragment=r,re.Profiler=o,re.PureComponent=X,re.StrictMode=l,re.Suspense=h,re.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=j,re.__COMPILER_RUNTIME={__proto__:null,c:function(E){return j.H.useMemoCache(E)}},re.cache=function(E){return function(){return E.apply(null,arguments)}},re.cloneElement=function(E,B,$){if(E==null)throw Error("The argument must be a React element, but you passed "+E+".");var Y=C({},E.props),W=E.key,de=void 0;if(B!=null)for(ne in B.ref!==void 0&&(de=void 0),B.key!==void 0&&(W=""+B.key),B)!ae.call(B,ne)||ne==="key"||ne==="__self"||ne==="__source"||ne==="ref"&&B.ref===void 0||(Y[ne]=B[ne]);var ne=arguments.length-2;if(ne===1)Y.children=$;else if(1<ne){for(var St=Array(ne),Ne=0;Ne<ne;Ne++)St[Ne]=arguments[Ne+2];Y.children=St}return pe(E.type,W,void 0,void 0,de,Y)},re.createContext=function(E){return E={$$typeof:d,_currentValue:E,_currentValue2:E,_threadCount:0,Provider:null,Consumer:null},E.Provider=E,E.Consumer={$$typeof:f,_context:E},E},re.createElement=function(E,B,$){var Y,W={},de=null;if(B!=null)for(Y in B.key!==void 0&&(de=""+B.key),B)ae.call(B,Y)&&Y!=="key"&&Y!=="__self"&&Y!=="__source"&&(W[Y]=B[Y]);var ne=arguments.length-2;if(ne===1)W.children=$;else if(1<ne){for(var St=Array(ne),Ne=0;Ne<ne;Ne++)St[Ne]=arguments[Ne+2];W.children=St}if(E&&E.defaultProps)for(Y in ne=E.defaultProps,ne)W[Y]===void 0&&(W[Y]=ne[Y]);return pe(E,de,void 0,void 0,null,W)},re.createRef=function(){return{current:null}},re.forwardRef=function(E){return{$$typeof:m,render:E}},re.isValidElement=ce,re.lazy=function(E){return{$$typeof:y,_payload:{_status:-1,_result:E},_init:F}},re.memo=function(E,B){return{$$typeof:g,type:E,compare:B===void 0?null:B}},re.startTransition=function(E){var B=j.T,$={};j.T=$;try{var Y=E(),W=j.S;W!==null&&W($,Y),typeof Y=="object"&&Y!==null&&typeof Y.then=="function"&&Y.then(we,ee)}catch(de){ee(de)}finally{j.T=B}},re.unstable_useCacheRefresh=function(){return j.H.useCacheRefresh()},re.use=function(E){return j.H.use(E)},re.useActionState=function(E,B,$){return j.H.useActionState(E,B,$)},re.useCallback=function(E,B){return j.H.useCallback(E,B)},re.useContext=function(E){return j.H.useContext(E)},re.useDebugValue=function(){},re.useDeferredValue=function(E,B){return j.H.useDeferredValue(E,B)},re.useEffect=function(E,B,$){var Y=j.H;if(typeof $=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return Y.useEffect(E,B)},re.useId=function(){return j.H.useId()},re.useImperativeHandle=function(E,B,$){return j.H.useImperativeHandle(E,B,$)},re.useInsertionEffect=function(E,B){return j.H.useInsertionEffect(E,B)},re.useLayoutEffect=function(E,B){return j.H.useLayoutEffect(E,B)},re.useMemo=function(E,B){return j.H.useMemo(E,B)},re.useOptimistic=function(E,B){return j.H.useOptimistic(E,B)},re.useReducer=function(E,B,$){return j.H.useReducer(E,B,$)},re.useRef=function(E){return j.H.useRef(E)},re.useState=function(E){return j.H.useState(E)},re.useSyncExternalStore=function(E,B,$){return j.H.useSyncExternalStore(E,B,$)},re.useTransition=function(){return j.H.useTransition()},re.version="19.1.0",re}var Ug;function Xf(){return Ug||(Ug=1,df.exports=w0()),df.exports}var N=Xf();const R0=Vv(N);var hf={exports:{}},fs={},pf={exports:{}},mf={};/**
 * @license React
